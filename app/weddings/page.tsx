      ...
      <section className="mx-auto max-w-7xl px-6 py-24 lg:px-10 lg:py-32">
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-24">
          <FadeUp>
            ...
            <p className="mt-5 font-body text-base font-light leading-[1.9] text-ink/80">
              ...
              <StaggerItem key={v.name}>
                <article>
                  ...
                  <div className="pt-6">
                    ...
                    <p className="mt-1 font-body text-[11px] uppercase tracking-[0.25em] text-gold">{v.capacity}</p>
      ...
      <section className="bg-forest">
        <div className="mx-auto max-w-4xl px-6 py-24 text-center lg:py-32">
          <FadeUp>
            ...
            <Link
              href="/contact"
              className="mt-10 inline-block bg-gold px-10 py-4 font-body text-[11px] uppercase tracking-[0.25em] text-forest transition-colors duration-300 hover:bg-parchment"
            >
