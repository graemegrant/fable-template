    ...
    <>
            ...
            {menus.map((menu) => (
              <StaggerItem key={menu.name}>
                <article className="h-full border border-ink/10 bg-parchment p-8">
                  ...
                  <p className="mt-2 font-body text-[11px] uppercase tracking-[0.2em] text-gold">{menu.note}</p>
      ...
      {chef && (
        <section className="bg-forest">
          <div className="mx-auto max-w-7xl px-6 py-24 lg:px-10 lg:py-32">
            <div className="grid items-center gap-12 lg:grid-cols-[360px_1fr] lg:gap-24">
              <FadeUp>
              ...
              <FadeUp delay={0.15}>
                ...
                <p className="mt-2 font-body text-[11px] uppercase tracking-[0.25em] text-gold">{chef.role}</p>
                <p className="mt-6 max-w-2xl font-body text-base font-light leading-[1.9] text-parchment/80">
