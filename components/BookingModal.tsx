      ...
      <ModalEntrance className="w-full max-w-lg">
        <div className="bg-parchment p-8 sm:p-10" onClick={(e) => e.stopPropagation()}>
          ...
          <form onSubmit={submit} className="mt-8 space-y-5">
            ...
            <button
              type="submit"
              className="w-full bg-forest px-8 py-4 font-body text-[11px] uppercase tracking-[0.25em] text-parchment transition-colors duration-300 hover:bg-gold hover:text-forest"
            >
              Check availability
            </button>
          </form>
